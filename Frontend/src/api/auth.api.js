...
export const authApi = {
  ...
  googleLogin: (payload) => http.post('/user/login/google', payload),
  ...
  sendSignupSmsOtp: (payload) => http.post('/user/signup/sms/send', payload),
  verifySignupSmsOtp: (payload) => http.post('/user/signup/sms/verify', payload),
